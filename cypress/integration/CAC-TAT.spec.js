...
describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  it('campo telefone continuará vazio quando preenchido com valor não-numérico', function() {
    cy.get('#phone')
      .type('abcdefghijklmnopqrstuvxyzç')
      .should('have.value', '')
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
    ...
    cy.get('#lastName')
      .type('Gorgen')
      .should('have.value', 'Gorgen')
      .clear()
      .should('have.value', '')
    cy.get('#email')
      .type('brunagorgen@exemplo.com')
      .should('have.value', 'brunagorgen@exemplo.com')
      .clear()
      .should('have.value', '')
    cy.get('#phone')
      .type('1234567890')
